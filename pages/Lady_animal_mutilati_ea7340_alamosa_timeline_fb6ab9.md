---
level: 2
basename: Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9
parent_basename: Lady_animal_mutilati_ea7340
child_basenames: []
sibling_basenames:
- Lady_animal_mutilati_ea7340_condon_report_findin_899be8
- Lady_animal_mutilati_ea7340_mutilation_folklore_4cd60d
tags:
...
- lady-animal-mutilation-1966
- timeline
affiliate_category: lady-animal-mutilation-1966
show_ads: true
description: The case is easier to understand when the missing mare, discovery, press spread, and later corrections are placed in order.
hero_summary: The case is easier to understand when the missing mare, discovery, press spread, and later corrections are placed in order.
layout: default
permalink: /timeline-084401/
sidebar_expanded_urls:
- /lady-animal-mutilation-1966/
nav_short_title: Timeline
title: How the Snippy Story Took Shape
title_full: How the Snippy Story Took Shape | Snippy
display_title_short: Timeline
display_title: Timeline
heading_title: How the Snippy Story Took Shape
page_heading_title: How the Snippy Story Took Shape
source_count: 21
infographic_count: 3
planned_sections:
- The mare's disappearance and discovery
- How newspapers turned Lady into Snippy
- Which details changed in later retellings
...
parent_title: Snippy
parent_permalink: /lady-animal-mutilation-1966/
parent_nav_short_title: Snippy
parent_heading_title: What Really Happened to Lady the Horse?
ancestor_links:
...
- basename: Lady_animal_mutilati_ea7340_condon_report_findin_899be8
  title: Condon Report | What Really Happened to Lady the Horse?
...
- basename: Lady_animal_mutilati_ea7340_mutilation_folklore_4cd60d
  title: Folklore Impact | What Really Happened to Lady the Horse?
...
image: /assets/images/Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9-Illustration-1-social.jpg
---
...
* allegedly smooth or “surgical” cuts around the neck
* little visible blood at the scene
* a sweet or chemical-like odour
* nearby circular depressions in the ground
* flattened vegetation
* claims that tracks abruptly stopped near the body
...
One important source-trail problem is that modern summaries often compress all later rumours into the original discovery.

The earliest widely distributed newspaper stories in October 1967 emphasised three elements above all:


<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. missing tissue around the head and neck
2. absence of obvious blood
3. speculation about “flying saucers”
...
### The Role of UFO Culture in 1967
...
* local ranch death
* regional newspaper curiosity
* national UFO framing
* later paranormal embellishment
* retrospective folklore

</div>

By the 1970s and 1980s, the case was no longer treated merely as a strange horse death. It had become the prototype for later “cattle mutilation” mythology across the American West.


<img src="{{ "/assets/images/Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9-Illustration-2-dark.svg" | relative_url }}" alt="Timeline illustration 2" data-theme-src-dark="{{ "/assets/images/Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The First Official and Semi-Official Responses
...
The Snippy/Lady story evolved substantially after 1967. Some of the most widely repeated elements are either poorly sourced or absent from early reports.

### Radiation Claims Expanded Over Time
...
### “Surgical Precision” Became More Dramatic
...
<img src="{{ "/assets/images/Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9-Illustration-3-dark.svg" | relative_url }}" alt="Timeline illustration 3" data-theme-src-dark="{{ "/assets/images/Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Lady_animal_mutilati_ea7340_alamosa_timeline_fb6ab9-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### The Timeline Itself Became Distorted

Even the year became unstable in later retellings. Some secondary sources incorrectly place the incident in 1966 rather than September 1967.

This matters because chronology errors often travel alongside other distortions. Once writers relied on previous UFO books instead of primary newspaper accounts or investigative summaries, inaccuracies multiplied. The horse’s name, ownership details, and discovery sequence all became vulnerable to drift.

## Why the Source Trail Matters

The Alamosa timeline is valuable precisely because it shows how a local livestock death transformed into a foundational UFO-era legend.

Several layers can still be separated with reasonable confidence:

* a mare disappeared in early September 1967
* the remains were found on 9 September
* local observers considered aspects of the carcass unusual

<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* newspapers sensationalised the case in October
* UFO interpretation rapidly overtook ordinary explanations
* later retellings expanded and embellished many details
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell fr-section-shell-fallback">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">No matched book cards were available for How the Snippy Story Took Shape, so this fallback keeps a direct Amazon reading path visible.</p>
    </div>
    <div class="fr-search-grid">

    <article class="fr-search-card">
      <p class="fr-search-kicker">Topical books</p>
      <h4 class="fr-search-title">Alamosa horse guide</h4>
      <p class="fr-search-desc">Browse books, explainers and reference titles related to this topic.</p>
      <a class="fr-amazon-btn" href="https://www.amazon.com/s?k=Alamosa+horse+guide&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">
        Search Amazon
      </a>
    </article>
    ...
    <article class="fr-search-card">
      ...
      <h4 class="fr-search-title">Alamosa Sheriff guide</h4>
      <p class="fr-search-desc">Browse books, explainers and reference titles related to this topic.</p>
      <a class="fr-amazon-btn" href="https://www.amazon.com/s?k=Alamosa+Sheriff+guide&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">
        Search Amazon
      </a>
    </article>
    ...
    <article class="fr-search-card">
      <p class="fr-search-kicker">Related search</p>
      <h4 class="fr-search-title">Snippy horse guide</h4>
      <p class="fr-search-desc">Browse books, explainers and reference titles related to this topic.</p>
      <a class="fr-amazon-btn" href="https://www.amazon.com/s?k=Snippy+horse+guide&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">
        Search Amazon
      </a>
    </article>
    </div>
...
<section class="further-reading-section" data-page-toc-exclude data-ebay-localized-links data-ebay-visual-market="EBAY_GB" aria-labelledby="merchant-block-title">
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.ebay.co.uk/sch/i.html?_nkw=US+Navy+ship+poster+-book+-books&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=timeline-084401-how-the-snippy-story-took-shape-lady-animal-mutilation-1966-us-navy-ship-poster-book-books&amp;toolid=10001" data-ebay-localized-link="1" data-ebay-query="US Navy ship poster -book -books" data-ebay-reference="timeline-084401-how-the-snippy-story-took-shape-lady-animal-mutilation-1966-us-navy-ship-poster-book-books" target="_blank" rel="sponsored noopener noreferrer" aria-label="Browse similar items on eBay