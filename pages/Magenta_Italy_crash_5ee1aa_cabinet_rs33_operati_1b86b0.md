...
show_ads: true
description: This page examines the claimed Fascist-era secret research group and its supposed studies of the Magenta object.
hero_summary: This page examines the claimed Fascist-era secret research group and its supposed studies of the Magenta object.
layout: default
...
page_heading_title: Who Was Behind Cabinet RS/33 and the Alleged Study of the Object?
source_count: 22
infographic_count: 3
planned_sections:
- Formation and authorization under Mussolini
- Key figures including Guglielmo Marconi
- Role in aviation and intelligence research
...
image: /assets/images/Magenta_Italy_crash_5ee1aa_cabinet_rs33_operati_1b86b0-Illustration-1-social.jpg
---
...
According to the modern retelling of the Magenta story, **Gabinetto RS/33** (“Special Researches 1933”) was established by Mussolini’s regime immediately after the alleged June 13 1933 incident, ostensibly to evaluate an unusual aircraft that had crashed or landed in northern Italy.¹ The name “RS/33” itself is said to combine *Ricerche Speciali* (special research) with the year 1933.¹ Alleged fascist‑era documents that surfaced in the late 1990s and early 2000s describe Mussolini ordering secrecy and instructing the formation of this cabinet to confer legitimacy and urgency on its mission.¹⁻²

Proponents locate RS/33’s authority at the highest levels of the regime: in the narrative, Mussolini personally endorsed the effort, with political protection from figures like Air Minister Italo Balbo and Foreign Minister Galeazzo Ciano.¹ Some versions add that the regime’s secret police, OVRA, was tasked with enforcing silence about the event and overseeing the cabinet’s covert work.² However, these assertions derive almost entirely from documents *claimed* to be originals or photocopies from 1930s fascist archives and first disseminated to Italian researchers by an anonymous source known only as “Mr X.”¹⁻²

### Documentary Basis and Provenance Questions
...
* Meeting notices referring to “RS/33.”³
* A sketch and descriptive memo of a metallic disc‑like craft, allegedly referenced in connection with RS/33.³
...
## Key Figures Attributed to RS/33

### Guglielmo Marconi and Scientific Leadership

A cornerstone of the RS/33 narrative is the alleged involvement of **Guglielmo Marconi**, Italy’s Nobel Prize‑winning pioneer of radio communications, named as the cabinet’s chair or chief scientific adviser.¹⁻² Proponents argue that Marconi’s stature offered technical credibility and regime backing for the secret research body.

However, there is **no independently verified contemporary documentation** placing Marconi on an intelligence or research committee tied to unexplained aerial phenomena in 1933. Details of his purported leadership derive from the same anonymous packets brought to light by Pinotti and Lissoni, not from Mussolini’s papers, Marconi’s own correspondence, or archive records.¹⁻²
...
* Immediate post‑crash recovery and transport of the object to secure facilities (often cited as the SIAI‑Marchetti hangars at Vergiate).¹
* Ongoing study under scientific and military oversight throughout the 1930s and into World War II.¹
* Alleged loss or transfer of materials in wartime, culminating in U.S. intelligence custody after 1944.¹
...
## Conclusion: Evidence Versus Assertion

The story of Cabinet RS/33 as a secret Mussolini‑sanctioned investigative body remains rooted in **ufological claims rather than verifiable historical documentation**. The entire narrative — including formation, leadership under Marconi, operational mission, and arc through World War II — stems from material that entered public awareness via anonymous sources, not through continuous archive provenance or official records.¹⁻²

Without independent confirmation from fascist era archives or corroborating testimony from contemporaneous sources, RS/33’s attributed operations remain speculative. For now, historians treat it as an unsubstantiated claim lying at the intersection of myth, mid‑century oral lore, and retrospective interpretation rather than as a documented component of 1930s Italian state science.¹⁻⁴

¹ These points are summarised in compilations of Italian ufological sources and the *Fascist UFO files* narrative. <span class="citation-chip-wrap"><a class="citation-chip" href="https://ufofiles.net/the-1933-magenta-case-italys-pre-roswell-crash-retrieval-claim-what-we-actually-know/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: ufofiles.net">[The UFO Files]</a><span class="citation-popover" role="note"><span class="citation-popover-source">ufofiles.net</span><span class="citation-popover-snippet">The UFO FilesThe 1933 “Magenta” Case: Italy’s Pre-Roswell Crash-Retrieval Claim—What We Actually Know - The UFO FilesSeptember 29, 2025...</span><span class="citation-popover-meta">Published: September 29, 2025</span></span></span>

² Claims about document details and RS/33 membership derive from ufological reconstructions. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.coloradomufon.org/the-magenta-case-italys-1933-ufo-mystery/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: coloradomufon.org">[Colorado MUFON]</a><span class="citation-popover" role="note"><span class="citation-popover-source">coloradomufon.org</span><span class="citation-popover-title">the magenta case italys 1933 ufo mystery</span><span class="citation-popover-snippet">Colorado MUFONThe Magenta Case: First Reported UFO Crash – Colorado MUFONMay 5, 2026...</span><span class="citation-popover-meta">Published: May 5, 2026</span></span></span>

³ Reports of specific telegrams, sketches, and RS/33 references are central to the UFO literature on Magenta. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.coloradomufon.org/the-magenta-case-italys-1933-ufo-mystery/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: coloradomufon.org">[Colorado MUFON]</a><span class="citation-popover" role="note"><span class="citation-popover-source">coloradomufon.org</span><span class="citation-popover-title">the magenta case italys 1933 ufo mystery</span><span class="citation-popover-snippet">Colorado MUFONThe Magenta Case: First Reported UFO Crash – Colorado MUFONMay 5, 2026...</span><span class="citation-popover-meta">Published: May 5, 2026</span></span></span>
