...
show_ads: true
description: Analysis of night-vision and camera effects that created the triangular visual illusion in the video.
hero_summary: Analysis of night-vision and camera effects that created the triangular visual illusion in the video.
layout: default
...
page_heading_title: How Night Vision and Camera Artifacts Created Pyramid Shapes
source_count: 26
infographic_count: 3
planned_sections:
- SLR and night vision interaction
- Bokeh and light artifact analysis
- Comparison with drone swarm footage
...
image: /assets/images/USS_Russell_video_20_3188a1_optical_artifacts_an_c86103-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/USS_Russell_video_20_3188a1_optical_artifacts_an_c86103-Illustration-1-light.svg" | relative_url }}" alt="Optical Effects illustration 1" data-theme-src-dark="{{ "/assets/images/USS_Russell_video_20_3188a1_optical_artifacts_an_c86103-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/USS_Russell_video_20_3188a1_optical_artifacts_an_c86103-Illustration-1-light.svg" | relative_url }}" loading="eager" decoding="sync" fetchpriority="high">
## NightVision Coupled with Camera Recording

The video that became known as the pyramid UAP was captured at night by sailors on board USS *Russell* using **nightvision imaging devices**, then recorded through a **singlelens reflex (SLR) camera** pointed at the eyepiece. The Department of Defense has publicly confirmed that this footage was taken through nightvision equipment and recorded for further analysis.<span class="citation-chip-wrap"><a class="citation-chip" href="https://en.wikipedia.org/wiki/Pentagon_UFO_videos" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Pentagon UFO videos</span><span class="citation-popover-snippet">Pentagon UFO videos</span></span></span>
...
## Aperture, Lens Shape and Bokeh Effects

One of the key optical explanations proposed by analysts for the pyramidlike impression is a variant of the **bokeh effect**, a wellknown phenomenon in photography and videography where *outoffocus light points take on the shape of a cameras aperture*. In normal photography, if the lens is focused far beyond a bright point light, the resulting blur or bokeh can take a polygonal shape reflecting the aperture blades inside the lens. On cameras with a triangularshaped aperture or diaphragm, outoffocus point lights can therefore appear triangular in the recorded image, even though the actual light source is not triangular.<span class="citation-chip-wrap"><a class="citation-chip" href="https://en.wikipedia.org/wiki/Pentagon_UFO_videos" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Pentagon UFO videos</span><span class="citation-popover-snippet">Pentagon UFO videos</span></span></span>

Nightvision goggles and optical sensor systems do not use typical photographic diaphragms, and their internal optics can produce other complex artefacts when filmed through a consumer camera. However, the *trianglelike bokeh* concept remains a useful analogue: **a threebladed or otherwise noncircular aperture in the imaging chain can turn point sources of light into triangular patches** in the recorded footage. This explains why what looked like a structured, geometric object in the video may have been *just a point light from a drone or aircraft navigation light rendered through the optical system*.<span class="citation-chip-wrap"><a class="citation-chip" href="https://en.wikipedia.org/wiki/Pentagon_UFO_videos" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Pentagon UFO videos</span><span class="citation-popover-snippet">Pentagon UFO videos</span></span></span>
...
* **Infrared sensor blooming:** Nightvision and FLIR (forwardlooking infrared) sensors can produce *blooming* when a bright light saturates the sensor, causing geometric streaks or shapes to emanate from the light source that do not correspond to physical structure.
* **Diffraction patterns:** Light passing through small apertures or multiple optical elements can diffract, creating patterns under certain conditions that resemble geometric figures rather than round blobs.
* **Secondary reflections:** Internal reflections within the eyepiece or between lens elements can generate ghost images or extended shapes that look permanent in the video but arent present in the outside scene.
...
<img src="{{ "/assets/images/USS_Russell_video_20_3188a1_optical_artifacts_an_c86103-Illustration-3-light.svg" | relative_url }}" alt="Optical Effects illustration 3" data-theme-src-dark="{{ "/assets/images/USS_Russell_video_20_3188a1_optical_artifacts_an_c86103-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/USS_Russell_video_20_3188a1_optical_artifacts_an_c86103-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Implications for Interpretation of the Footage

Understanding the optical and camera factors here has two key implications for how the *USS Russell* video should be interpreted:

* **Shape in the video does not equal physical structure:** The geometric triangle seen in the released clip is not reliable evidence of a triangular craft; it reflects how the imaging system rendered bright light sources.
* **Optics matter in UAP analysis:** Nightvision and camera artefacts must be carefully considered in UAP investigations, especially when the only available evidence is video from complex optical setups. Misinterpretation of sensor effects can lead to inflated claims about object shape or behaviour.
