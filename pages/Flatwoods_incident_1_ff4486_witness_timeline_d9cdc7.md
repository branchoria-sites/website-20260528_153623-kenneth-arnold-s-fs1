...
show_ads: true
description: The Flatwoods story turns on a fast-moving evening search, a brief sighting, and later retellings that do not always agree.
hero_summary: The Flatwoods story turns on a fast-moving evening search, a brief sighting, and later retellings that do not always agree.
layout: default
permalink: /timeline-91eec0/
sidebar_expanded_urls:
- /flatwoods-incident-1952/
nav_short_title: Timeline
title: Who Saw What on the Hill?
title_full: Who Saw What on the Hill? | Flatwoods
display_title_short: Timeline
display_title: Timeline
heading_title: Who Saw What on the Hill?
page_heading_title: Who Saw What on the Hill?
source_count: 43
infographic_count: 3
planned_sections:
...
After the sighting, the boys returned to the May residence and informed Kathleen May, who became the most publicly identified witness in later years. The search party that formed afterwards is one of the most repeated elements of the case, but even here there are inconsistencies.

The names most commonly included are:
...
* A tall or elevated figure
* A red or glowing face
* A hooded, pointed or spade-shaped outline
* Dark clothing or a metallic-looking body
* Bright eye-like features
* A hissing or hovering impression
...
## Why the Hilltop Description Changed Over Time
...
* The creature became taller and more clearly humanoid.
* The glowing eyes and hood shape became more vivid.
* The movement became more supernatural or mechanical.
* The “craft landing” implication grew stronger.
* The timeline became cleaner and more cinematic.
...
## The Owl Theory and the Problem of Perspective

The most influential sceptical reconstruction came from investigator Joe Nickell, who argued that the witnesses probably combined several ordinary stimuli into one frightening interpretation. In this [explanation]({{ 'explanation/' | relative_url }}):


<div class="content-enhancement content-enhancement--insight-grid" markdown="1">

* The bright object in the sky was likely a meteor seen across multiple states.
* The pulsing red light may have been an aircraft beacon or distant light source.
...
The owl explanation gained traction partly because it matches several reported features surprisingly well. A startled owl illuminated at night can appear to have glowing eyes and a sharply outlined face. If perched on a branch with foliage beneath it, the silhouette could appear much taller than it really was. A sudden movement by the bird might also explain why witnesses thought the figure glided toward them. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.snopes.com/articles/383097/flatwoods-monster-mothman-owl/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: snopes.com">[Snopes]</a><span class="citation-popover" role="note"><span class="citation-popover-source">snopes.com</span><span class="citation-popover-title">flatwoods monster mothman owl</span><span class="citation-popover-snippet">SnopesWhat Was the Flatwoods Monster?4 Dec 2021 — Lemon shined his flashlight up the hill, and the group witnessed a terrifying sight—a t...</span></span></span>
...
## What Can Actually Be Established With Confidence?

Despite decades of retelling, the securely documented part of the timeline is relatively narrow.

Several points are strongly supported:

* Witnesses genuinely saw a bright aerial object on 12 September 1952.
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell fr-section-shell-fallback">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">No matched book cards were available for Who Saw What on the Hill?, so this fallback keeps a direct Amazon reading path visible.</p>
    </div>
    ...
    <article class="fr-search-card">
      ...
      <h4 class="fr-search-title">West Virginia National Guard guide</h4>
      <p class="fr-search-desc">Browse books, explainers and reference titles related to this topic.</p>
      <a class="fr-amazon-btn" href="https://www.amazon.com/s?k=West+Virginia+National+Guard+guide&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">
        Search Amazon
      </a>
    </article>
    ...
    <article class="fr-search-card">
      <p class="fr-search-kicker">Related search</p>
      <h4 class="fr-search-title">West Virginia guide</h4>
      <p class="fr-search-desc">Browse books, explainers and reference titles related to this topic.</p>
      <a class="fr-amazon-btn" href="https://www.amazon.com/s?k=West+Virginia+guide&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer">
        Search Amazon
      </a>
    </article>
    </div>
...
<section class="further-reading-section" data-page-toc-exclude data-ebay-localized-links data-ebay-visual-market="EBAY_GB" aria-labelledby="merchant-block-title">
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.ebay.co.uk/sch/i.html?_nkw=US+Navy+ship+poster+-book+-books&amp;mkevt=1&amp;mkcid=1&amp;mkrid=710-53481-19255-0&amp;campid=5339151051&amp;customid=timeline-91eec0-who-saw-what-on-the-hill-flatwoods-incident-1952-us-navy-ship-poster-book-books&amp;toolid=10001" data-ebay-localized-link="1" data-ebay-query="US Navy ship poster -book -books" data-ebay-reference="timeline-91eec0-who-saw-what-on-the-hill-flatwoods-incident-1952-us-navy-ship-poster-book-books" target="_blank" rel="sponsored noopener noreferrer" aria-label="Browse similar items on eBay for USS Leyte CV-32 Wright Quonset Point US Navy Military Ship Poster Photo 24x36"><img src="{{ '/assets/images/marketplace-covers/adba4a0fdcf90dcdb80f.jpg' | relative_url }}" alt="Listing image for USS Leyte CV-32 Wright Quonset Point US Navy Military Ship Poster Photo 24x36" loading="lazy" decoding="async" fetchpriority="low"></a>
...
6. <a id="endnote-6"></a>
   ...
   <details class="endnote-snippet"><summary>Source snippet</summary><p>SnopesWhat Was the Flatwoods Monster?4 Dec 2021 — Lemon shined his flashlight up the hill, and the group witnessed a terrifying sight—a t...</p></details>
...
9. <a id="endnote-9"></a>
   ...
   Link: [https://hangar1publishing.com/blogs/ufos-uaps-and-aliens/the-flatwoods-monster?srsltid=AfmBOopmYEpw_luefnwD2jbBh_-4zqePTeZgm2D5x7nRYUu9AtKn70Dh](https://hangar1publishing.com/blogs/ufos-uaps-and-aliens/the-flatwoods-monster?srsltid=AfmBOopmYEpw_luefnwD2jbBh_-4zqePTeZgm2D5x7nRYUu9AtKn70Dh)  
...
10. <a id="endnote-10"></a>
   ...
   Link: [https://maeclair.net/2015/06/01/mythical-monday-the-flatwoods-monster-by-mae-clair/](https://maeclair.net/2015/06/01/mythical-monday-the-flatwoods-monster-by-mae-clair/)  
...
14. <a id="endnote-14"></a>
   Source: youtube.com  
   Link: [https://www.youtube.com/watch?v=epueMpPZ_Ww](https://www.youtube.com/watch?v=epueMpPZ_Ww)  
...
18. <a id="endnote-18"></a>
   ...
   Link: [https://www.imdb.com/title/tt7620540/](https://www.imdb.com/title/tt7620540/)  
    <details class="endnote-snippet"><summary>Source snippet</summary><p>IMDbHynek and Quinn investigate a West Virginia case of a mother and her two children who witnessed an alien being emerge from a fiery UF...</p></details>
...
22. <a id="endnote-22"></a>
   ...
   Link: [https://www.instagram.com/p/DXsJShjEm_i/](https://www.instagram.com/p/DXsJShjEm_i/)  
