...
show_ads: true
description: The leading skeptical explanation is an unusual atmospheric mirage, but the available radar and weather evidence remains incomplete.
hero_summary: The leading skeptical explanation is an unusual atmospheric mirage, but the available radar and weather evidence remains incomplete.
layout: default
...
page_heading_title: Could a Mirage Explain the Objects?
source_count: 35
infographic_count: 3
planned_sections:
- Why the Condon Report favored an optical cause
- Missing radar confirmation and weak physical evidence
- Why the mirage theory remains plausible but unusual
...
- basename: BOAC_stratocruiser_s_01e20e_flight_timeline_goos_c17e02
  title: Timeline | What Did the BOAC Crew Really See?
...
image: /assets/images/BOAC_stratocruiser_s_01e20e_mirage_evidence_limi_5021c9-Illustration-1-social.jpg
---
...
The Labrador and Newfoundland region is one of the environments where such effects are physically plausible. Cold ocean surfaces, strong inversion layers, and low-angle sunlight near sunset can create complex refractive conditions. Martin Shough’s later analysis argued that the BOAC objects may have been distant cloud structures or other horizon features transformed by unusual refraction at high altitude.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.academia.edu/66678850/Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April_23_2007_Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: academia.edu">[Academia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">academia.edu</span><span class="citation-popover-snippet">http... If real this would rule out a simple mirage theory. This is not a...Read more...</span></span></span>
...
## Why the Condon Report leaned towards an optical explanation

The University of Colorado UFO Project, commonly called the Condon Committee, revisited the BOAC case during the late 1960s as part of its broader review of significant UFO reports. The committee did not claim to have solved the sighting conclusively, but its analysis leaned towards an optical or refractive explanation rather than a structured craft.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/Condon_Committee" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Condon Committee</span><span class="citation-popover-snippet">April 17, 2026 — The Condon Committee was the informal name of the University of Colorado UFO Project, a group funded by the United State...</span><span class="citation-popover-meta">Published: April 17, 2026</span></span></span>

Several aspects of the report pushed investigators in that direction:

* The objects appeared to remain at a nearly constant relative bearing for a prolonged period.
* Their apparent motion depended heavily on the aircraft’s own movement and changing perspective.
* The forms reportedly changed shape rather than maintaining stable geometry.
* No confirmed independent radar target was obtained despite military interest and fighter interception attempts.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.academia.edu/66678850/Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April_23_2007_Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: academia.edu">[Academia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">academia.edu</span><span class="citation-popover-snippet">http... If real this would rule out a simple mirage theory. This is not a...Read more...</span></span></span><span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.nicap.org/reports/boac.htm" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nicap.org">[nicap.org]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nicap.org</span><span class="citation-popover-snippet">BOAC Case: UFOS Follow British Airliner Over LabradorUnfortunately, Goose Bay had only short range airfield control radar at the time, an...</span></span></span>

The committee also considered the possibility that the [witnesses]({{ 'witnesses-eac7bf/' | relative_url }}) had been observing refracted cloud formations near the horizon. A mirage could theoretically explain why the objects appeared large, dark, and oddly structured without requiring extraordinary speed or manoeuvres. Importantly, the optical explanation allowed investigators to accept the sincerity of the crew while rejecting the need for an unknown vehicle hypothesis.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.academia.edu/66678850/Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April_23_2007_Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: academia.edu">[Academia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">academia.edu</span><span class="citation-popover-snippet">http... If real this would rule out a simple mirage theory. This is not a...Read more...</span></span></span>

This was a crucial distinction. The BOAC witnesses were widely regarded as credible and experienced. The mirage theory effectively argued that reliable observers can still misinterpret extraordinary atmospheric conditions, especially during prolonged observations over featureless terrain or ocean.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.academia.edu/66678850/Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April_23_2007_Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: academia.edu">[Academia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">academia.edu</span><span class="citation-popover-snippet">http... If real this would rule out a simple mirage theory. This is not a...Read more...</span></span></span>
...
One reason the case remains debated is that the available radar evidence is fragmentary and frustratingly incomplete.

Howard’s own voyage report stated that Goose Bay Fighter Control had the BOAC aircraft on radar but “nothing else”. Later retellings added confusion by suggesting that interceptor aircraft may have searched for the objects without obtaining radar contact. Goose Bay reportedly possessed only short-range airfield radar at the time, limiting what could realistically have been detected.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.nicap.org/NSID_DBListingbyCat9.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nicap.org">[nicap.org]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nicap.org</span><span class="citation-popover-title">11/30/12 Category 09</span><span class="citation-popover-snippet">The object, showing on ground radar along with the F-94.Read more...</span></span></span>

For sceptics, the absence of radar confirmation strongly supports the mirage interpretation. If no solid target appeared on military radar, then the phenomenon may have been purely optical. A refracted image or distant atmospheric feature would not necessarily generate a radar return corresponding to a physical object near the Stratocruiser.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.academia.edu/66678850/Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April_23_2007_Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: academia.edu">[Academia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">academia.edu</span><span class="citation-popover-snippet">http... If real this would rule out a simple mirage theory. This is not a...Read more...</span></span></span>

However, the radar issue is not as decisive as it first appears.

The surviving records are incomplete, and there is no detailed technical reconstruction of exactly what radar systems were operating, what ranges they covered, what altitude filters were used, or whether the interceptor’s onboard radar ever had an adequate opportunity to acquire the reported objects. Mid-1950s radar coverage in Labrador was limited and heavily dependent on ground-control priorities. The absence of a surviving radar track therefore weakens the case for physical craft, but it does not conclusively disprove the crew’s observations.<span class="citation-chip-wrap"><a class="citation-chip" href="https://dokumen.pub/the-outsiders-guide-to-ufos-volume-2-what-are-they-0244797315-9780244797317.html" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: dokumen.pub">[2dokumen.pub]</a><span class="citation-popover" role="note"><span class="citation-popover-source">dokumen.pub</span><span class="citation-popover-title">The Outsider&#x27;s Guide to UFOs Volume 2: What are They?</span><span class="citation-popover-snippet">Having said all that, the outsider should take a good look at the NARCAP study which is set out on Martin Shough&#x27;s website. In common wit...</span></span></span>

The same limitation affects the mirage theory itself. If the objects were refracted images of distant physical features, investigators would ideally want detailed meteorological records, upper-air soundings, and exact atmospheric profiles from the region at the relevant time. Much of that material either was never preserved or has not survived in accessible form. The optical explanation therefore remains partly inferential rather than experimentally demonstrated.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.academia.edu/66678850/Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April_23_2007_Report_on_aerial_phenomena_observed_near_the_Channel_Islands_UK_April" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: academia.edu">[Academia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">academia.edu</span><span class="citation-popover-snippet">http... If real this would rule out a simple mirage theory. This is not a...Read more...</span></span></span>
...
## Why the mirage explanation remains plausible but unusual

The mirage theory survives because it explains more of the reported behaviour than many competing natural explanations.
...
* Multiple apparent objects from one distant source.
* Dramatic distortion and shape changes.
* Apparent hovering or pacing behaviour.
* Abrupt shrinking or disappearance as viewing geometry changes.
* Dark silhouettes against bright twilight backgrounds.<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.atoptics.org.uk/fz150.htm" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: atoptics.org.uk">[2atoptics.org.uk]</a><span class="citation-popover" role="note"><span class="citation-popover-source">atoptics.org.uk</span><span class="citation-popover-title">Strange Ships, Superior Mirages</span><span class="citation-popover-snippet">The lower picture has parts of a third upright ship above the inverted one! These are &#x27;superior&#x27; mirages -...Read more...</span></span></span>

</div>

Yet the theory also remains unusual because such mirages are genuinely rare in aviation contexts at cruising altitude. Even investigators sympathetic to the explanation generally describe it as an uncommon convergence of atmospheric conditions rather than an everyday optical illusion.<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.caelestia.be/BOAC.html" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: caelestia.be">[caelestia.be]</a><span class="citation-popover" role="note"><span class="citation-popover-source">caelestia.be</span><span class="citation-popover-snippet">CAELESTIA The BOAC Labrador sightingSeveral theories have been advanced. Were these objects spaceships, a giant flock of migrating starli...</span></span></span>

That rarity matters historically. The BOAC sighting is not remembered because investigators lacked any possible explanation. It is remembered because the leading conventional explanation itself depends on a relatively exotic atmospheric phenomenon that cannot now be reconstructed with certainty from surviving evidence.
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=Color+and+Light+in+Nature+David+K.+Lynch&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open Color and Light in Nature on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://books.google.com/books/content?id=4Abp5FdhskAC&amp;printsec=frontcover&amp;img=1&amp;zoom=1&amp;edge=curl&amp;source=gbs_api" alt="Cover for Color and Light in Nature" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=Color+and+Light+in+Nature+David+K.+Lynch&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="Color and Light in Nature">Color and Light in Nature</a>
        </h4>
        <p class="fr-book-author">By David K. Lynch, William Charles Livingston</p>

        <p class="fr-book-desc">We live in a world of optical marvels - from the commonplace but beautiful rainbow, to the rare and eerie superior mirage. But how many o...</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=Color+and+Light+in+Nature+David+K.+Lynch&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover fr-book-cover-placeholder" href="https://www.amazon.com/s?k=Scientific+Study+of+Unidentified+Flying+Objects+Edward+U.+Condon&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open Scientific Study of Unidentified Flying Objects on Amazon"><span class="fr-book-cover-fallback">Book</span></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=Scientific+Study+of+Unidentified+Flying+Objects+Edward+U.+Condon&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="Scientific Study of Unidentified Flying Objects">Scientific Study of Unidentified Flying Objects</a>
        </h4>
        <p class="fr-book-author">By Edward U. Condon</p>
        ...
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=Scientific+Study+of+Unidentified+Flying+Objects+Edward+U.+Condon&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
