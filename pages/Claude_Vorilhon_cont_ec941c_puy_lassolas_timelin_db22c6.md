...
show_ads: true
description: The claimed December 1973 meetings become clearer when the volcanic site, disputed dates, and rapid publication timeline are separated.
hero_summary: The claimed December 1973 meetings become clearer when the volcanic site, disputed dates, and rapid publication timeline are separated.
layout: default
...
page_heading_title: What Supposedly Happened at Puy de Lassolas?
source_count: 39
infographic_count: 3
planned_sections:
- The December 1973 setting
- Six meetings and date variants
- From encounter claim to published mission
...
image: /assets/images/Claude_Vorilhon_cont_ec941c_puy_lassolas_timelin_db22c6-Illustration-1-social.jpg
---
...
### Claimed First Contact: 13 December 1973

According to Raëlian accounts, **Claude Vorilhon (then 27)** had his first encounter **on the morning of 13 December 1973** at Puy de Lassolas. He said he met a diminutive humanoid extraterrestrial—identified in later materials as “**Yahweh**”—who communicated with him and imparted a message about humanity’s cosmic origins. This encounter is repeatedly cited in Raëlian literature as occurring on that date at the volcano’s crater.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://www.rael.org/rael/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: rael.org">[RAEL.ORG]</a><span class="citation-popover" role="note"><span class="citation-popover-source">rael.org</span><span class="citation-popover-title">The Last Prophet, Rael</span><span class="citation-popover-snippet">At the age of 27, on the morning of De...</span></span></span>
...
While Raëlian sources consistently specify **13 December** for the first contact, some secondary summaries have **slightly different dates** for aspects of the encounter (for example, an early encounter dated to **3 December** in a general reference summary). However, the movement’s own timeline and most academic treatments anchor the **13 December** date as central to the story’s internal chronology.<span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/Puy_de_D%C3%B4me" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-title">Puy de Dôme</span><span class="citation-popover-snippet">Puy de DômeIt is approximately 10 km (6 miles) from Clermont-Ferrand. The Puy-de-Dôme département is named after the volcano.Read more...</span></span></span>
...
Across Raëlian and academic sources:
