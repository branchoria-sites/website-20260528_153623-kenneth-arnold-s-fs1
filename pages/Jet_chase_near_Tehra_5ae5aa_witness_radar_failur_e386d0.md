...
title_full: How Strong Is the Tehran Evidence?
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to How Strong Is the Tehran Evidence?. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Features the official U.S. reporting statements regarding the radar lock and visual correlation claims made by the F-4 crews.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Reviews the multi-layered communications, instruments, and weapons-panel failures that affected separate aircraft simultaneously.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Explains why separate witness categories from different locations can inadvertently corroborate misidentified astronomical features.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Analyzes the administrative processing of foreign military visual alerts by American air defense consultants.</p>
        <div class="fr-book-actions">
