...
title: Why Angelucci Became a 1950 s Contactee Figure
title_full: Why Angelucci Became a 1950 s Contactee Figure
display_title_short: Contactee Era
display_title: Contactee Era
heading_title: Why Angelucci Became a 1950 s Contactee Figure
page_heading_title: Why Angelucci Became a 1950 s Contactee Figure
source_count: 31
infographic_count: 3
planned_sections:
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Why Angelucci Became a 1950s Contactee Figure. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    <div class="fr-books-grid">

    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=The+Secret+of+the+Saucers+Orfeo+Angelucci&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open The Secret of the Saucers on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://books.google.com/books/content?id=LUk4zgEACAAJ&amp;printsec=frontcover&amp;img=1&amp;zoom=1&amp;source=gbs_api" alt="Cover for The Secret of the Saucers" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=The+Secret+of+the+Saucers+Orfeo+Angelucci&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="The Secret of the Saucers">The Secret of the Saucers</a>
        </h4>
        <p class="fr-book-author">By Orfeo Angelucci</p>

        <p class="fr-book-desc">The primary source text that defined Angelucci&#x27;s place in the 1950s saucer subculture, presenting his space brother philosophy and nuclea...</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=The+Secret+of+the+Saucers+Orfeo+Angelucci&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Analyzes the 1950s contactee movement through a folkloric lens, evaluating why skeptics view these accounts as visionary spiritual narrat...</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Deconstructs the psychological mechanisms of how atomic anxiety and rapid technological change generate new religious mythologies.</p>
        <div class="fr-book-actions">
