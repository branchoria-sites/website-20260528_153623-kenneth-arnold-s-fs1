...
show_ads: true
description: The alleged nasal implant gave the story a concrete hook, but surgery reportedly failed to find the object shown on imaging.
hero_summary: The alleged nasal implant gave the story a concrete hook, but surgery reportedly failed to find the object shown on imaging.
layout: default
permalink: /implant/
...
page_heading_title: Was There Any Physical Evidence?
source_count: 22
infographic_count: 3
planned_sections:
- The X ray and implant interpretation
- The surgery that found nothing
- Why ambiguous evidence gained power
...
- basename: Linda_Cortile_abduct_1b229f_hopkins_hypnosis_47c88d
  title: Hopkins | Was the Brooklyn Bridge Abduction Witnessed?
  permalink: /hopkins/
  short_title: Hopkins
...
image: /assets/images/Linda_Cortile_abduct_1b229f_nasal_implant_9ade29-Illustration-1-social.jpg
---
...
## Why the image itself remained inconclusive

Despite its reputation, the implant evidence never reached the level of documented medical proof that many outsiders assumed existed.

Public discussion of the X-ray generally relied on second-hand descriptions, reproduced images, or Hopkins’s interpretation rather than on a complete published medical analysis. Critics noted that no detailed peer-reviewed examination established the object’s composition, origin, or even certainty that it was truly an implanted foreign body rather than a normal anatomical feature, imaging artefact, or ordinary medical anomaly. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.tricksterbook.com/ArticlesOnline/LindaCase.htm" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: tricksterbook.com">[tricksterbook.com]</a><span class="citation-popover" role="note"><span class="citation-popover-source">tricksterbook.com</span><span class="citation-popover-snippet">A Critique of Budd Hopkins&#x27; Case of the UFO Abduction of...Linda has reported nose bleeds, and one X-ray displays an implant in her nose...</span></span></span>

The ambiguity became more serious because accounts of the object varied over time:
...
## The surgery that reportedly found nothing
...
1. An ambiguous anomaly is identified.
2. The anomaly is interpreted through an extraterrestrial framework.
3. Follow-up verification fails or remains incomplete.
4. The unresolved gap is then reinterpreted as further mystery rather than evidential weakness.

</div>

That pattern appears repeatedly in critical examinations of Hopkins’s work and in later commentary on the Cortile/Napolitano case. <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.tricksterbook.com/ArticlesOnline/LindaCase.htm" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: tricksterbook.com">[tricksterbook.com]</a><span class="citation-popover" role="note"><span class="citation-popover-source">tricksterbook.com</span><span class="citation-popover-snippet">A Critique of Budd Hopkins&#x27; Case of the UFO Abduction of...Linda has reported nose bleeds, and one X-ray displays an implant in her nose...</span></span></span>

## Carol Rainey’s challenge to the implant story

The implant issue gained renewed attention decades later through criticism from filmmaker Carol Rainey, Hopkins’s former wife and collaborator.

Rainey initially supported Hopkins’s investigations and filmed extensive material connected to alien-abduction research. Over time, however, she became one of the most prominent critics of the Cortile/Napolitano case. In interviews and documentary footage later used in Netflix’s *The Manhattan Alien Abduction*, Rainey openly questioned both the hypnosis methods and the implant evidence. <span class="citation-chip-wrap"><a class="citation-chip" href="https://nypost.com/2024/10/31/entertainment/manhattan-alien-abduction-woman-claiming-1989-story-sues-netflix-over-doc/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nypost.com">[New York Post]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nypost.com</span><span class="citation-popover-snippet">New York Post&#x27;Manhattan Alien Abduction&#x27;: Woman claiming 1989 story...October 31, 2024 — Oct 31, 2024 — Napolitano also shared an X-ray...</span><span class="citation-popover-meta">Published: October 31, 2024</span></span></span> <span class="citation-link-wrap"><a class="citation-inline-link" href="https://en.wikipedia.org/wiki/Budd_Hopkins" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: Wikipedia">[Wikipedia]</a><span class="citation-popover" role="note"><span class="citation-popover-source">Wikipedia</span><span class="citation-popover-snippet">Budd Hopkins... implants that were alluded to (particularly in the case of alleged abductee Linda Cortile) but never recovered, photog...</span></span></span>

Her criticism of the X-ray was blunt. Rainey suggested the image could potentially have been fabricated or manipulated through simple means, including positioning metal externally near the nose during imaging. She also emphasised that later surgery failed to recover the supposed implant. <span class="citation-chip-wrap"><a class="citation-chip" href="https://nypost.com/2024/10/31/entertainment/manhattan-alien-abduction-woman-claiming-1989-story-sues-netflix-over-doc/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: nypost.com">[New York Post]</a><span class="citation-popover" role="note"><span class="citation-popover-source">nypost.com</span><span class="citation-popover-snippet">New York Post&#x27;Manhattan Alien Abduction&#x27;: Woman claiming 1989 story...October 31, 2024 — Oct 31, 2024 — Napolitano also shared an X-ray...</span><span class="citation-popover-meta">Published: October 31, 2024</span></span></span>

These claims did not conclusively disprove the implant story, but they shifted the burden of proof. Once the object was unrecoverable and allegations of possible fabrication entered public discussion, the evidential value of the X-ray depended almost entirely on trust in [witnesses]({{ 'witnesses-011357/' | relative_url }}) and investigators.
...
* **Medical imagery carries authority.** X-rays appear objective to non-specialists, even when interpretation is uncertain.
* **Physical evidence changes narrative tone.** A claimed implant sounds more concrete than dreams or recovered memories.
* **Incomplete evidence invites projection.** Believers and sceptics can both fit ambiguous findings into pre-existing worldviews.
* **The missing object increased drama.** The failure to recover the implant transformed a weakly supported claim into an unresolved mystery.
...
Today, the nasal implant claim remains unresolved in the narrowest sense: no definitive explanation for the X-ray image was ever publicly established. But neither was any alien device recovered or scientifically verified.

That unresolved status is exactly why the episode still matters in discussions of the Linda Cortile abduction. It demonstrates how UFO cases can gain public momentum through fragments of apparently physical evidence even when the underlying documentation remains incomplete or disputed.

For supporters, the implant still represents one of the few moments where the case appeared to cross from subjective experience into measurable reality. For sceptics, it illustrates how easily uncertain medical findings can become amplified into extraordinary claims without satisfying normal evidential standards.
