...
show_ads: true
description: The Adamski death shaped the legend around Godfrey's encounter, but proximity does not prove the two events were connected.
hero_summary: The Adamski death shaped the legend around Godfrey's encounter, but proximity does not prove the two events were connected.
layout: default
permalink: /todmorden-link/
sidebar_expanded_urls:
- /alan-godfrey-encounter-1980/
nav_short_title: Todmorden Link
title: Did Adamski's Death Change the UFO Story?
title_full: Did Adamski's Death Change the UFO Story?
display_title_short: Todmorden Link
display_title: Todmorden Link
heading_title: Did Adamski's Death Change the UFO Story?
page_heading_title: Did Adamski's Death Change the UFO Story?
source_count: 21
infographic_count: 3
planned_sections:
- The June 1980 Adamski case
- Why the two stories became linked
...
image: /assets/images/Alan_Godfrey_encount_87fc0b_adamski_todmorden_li_d850b0-Illustration-1-social.jpg
---
...
### Geography, timing, and a shared witness

The strongest reason the two incidents became connected was simple narrative structure.
...
This pattern is common in UFO folklore. Separate incidents become grouped together because they share witnesses, locations, or symbolic details. In Todmorden’s case, the repetition of certain motifs — burns, missing time, unexplained marks, strange lights, official uncertainty — encouraged audiences to see continuity even where direct evidence was lacking.
...
This process amplified certain details while reducing others. For example:
...
<img src="{{ "/assets/images/Alan_Godfrey_encount_87fc0b_adamski_todmorden_li_d850b0-Illustration-2-dark.svg" | relative_url }}" alt="Todmorden Link illustration 2" data-theme-src-dark="{{ "/assets/images/Alan_Godfrey_encount_87fc0b_adamski_todmorden_li_d850b0-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Alan_Godfrey_encount_87fc0b_adamski_todmorden_li_d850b0-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## What official records do and do not show

### No confirmed official link between the cases
...
The Todmorden story survives partly because both cases contain genuine unresolved elements.

For Adamski:

* there are still unanswered questions about his movements and the exact circumstances of his death.

For Godfrey:

* there remains no definitive explanation for what he believed he saw on Burnley Road.

But unresolved does not automatically mean connected. The strongest evidence for a link is circumstantial:
...
The weakest part of the connection is the absence of direct corroboration. There is:
...
Even without proof of a shared cause, the Adamski-Godfrey pairing became one of the defining narratives in British UFO culture. It offered something more compelling than a single unexplained sighting: a continuing local mystery involving death, police testimony, missing time, unexplained injuries, and official ambiguity.
...
[- The National Archives([https://www.nationalarchives.gov.uk](https://www.nationalarchives.gov.uk))](#endnote-12 "Endnote 12")
